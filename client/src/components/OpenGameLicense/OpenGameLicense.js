...
const OpenGamingLicense = () => {
  return (
    <div className="ViewPageHolder">
      ...
      <div className="OpenGamingLicense">
        ...
        <div className="OpenGamingLicenseText">
          ...
          <p>
            ...
            defined in Section 1(e) of the Open Game License Version 1.0a, and
            are subject to the conditions set forth in Section 7 of the OGL, and
            are not Open Content: Dungeons & Dragons, D&D, Player’s Handbook,
            Dungeon Master, Monster Manual, d20 System, Wizards of the Coast,
            d20 (when used as a trademark), Forgotten Realms, Faerûn, proper
            names (including those used in the names of spells or items),
            places, Underdark, Red Wizard of Thay, the City of Union, Heroic
            Domains of Ysgard, EverChanging Chaos of Limbo, Windswept Depths of
            ...
            illithid, umber hulk, yuan-ti. All of the rest of the SRD5 is Open
          ...
          <p>
            ...
            Permission granted to print or photocopy this document for personal
          ...
          <p>
            ...
            Crawford, Chris Perkins, Rodney Thompson, Peter Lee, James Wyatt,
...
export default OpenGamingLicense;
