...
import { createNPC, getCurrentProfile } from "../../actions/profileActions";
...
class CreateNPC extends Component {
 ...
 UNSAFE_componentWillReceiveProps(nextProps) {
  ...
  onSubmit = e => {
    ...
    this.props.createNPC(npcData, this.props.history);
  };
        ...
        <div className="ViewPageHolder">
          ...
          <div onClick={this.onSubmit} className="BookSubmitButton NPCColor">
            <div className="ButtonColorHelper">
              <div className="CenteredPlusNoColor">Create NPC</div>
            </div>
          </div>
        </div>
      );
...
export default connect(
  mapStateToProps,
  { createNPC, getCurrentProfile }
)(withRouter(CreateNPC));
