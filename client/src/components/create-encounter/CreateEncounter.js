...
import InitiativeDisplay from "./InitiativeManager/InitiativeDisplay";
import DiceRoller from "./DiceRoller/DiceRoller";
import RulesHelper from "./RulesHelper/RulesHelper";
import {
  createEncounter,
  openGamingLicense,
  getCurrentProfile,
...
import IndividualCharacter from "./CharacterManager/IndividualCharacter";
import IndividualMonster from "./MonsterManager/IndividualMonster";
import IndividualNPC from "./NPCManager/IndividualNPC";
...
class CreateEncounter extends Component {
  ...
  onSubmit = () => {
    ...
    this.props.createEncounter(encounter, this.props.history);
  };
