...
import { editMonster } from "../../../actions/profileActions";
import Book from "../../../images/book_dmkit_cropped.png";
import classnames from "classnames";

class EditMonster extends Component {
  state = {
    monsterId: window.location.pathname.substr(10, 200),
    name: "",
    image: "",
    alignment: "",
    strength: "",
  ...
  componentWillMount = () => {
    ...
    this.setState({
      name: neededMonster.name,
      image: neededMonster.image,
      alignment: neededMonster.alignment,
      loot: neededMonster.loot,
      strength: neededMonster.strength,
      dexterity: neededMonster.dexterity,
      constitution: neededMonster.constitution,
      intelligence: neededMonster.intelligence,
      wisdom: neededMonster.wisdom,
      charisma: neededMonster.charisma,
      strength_save: neededMonster.strength_save,
      dexterity_save: neededMonster.dexterity_save,
      constitution_save: neededMonster.constitution_save,
      intelligence_save: neededMonster.intelligence_save,
      wisdom_save: neededMonster.wisdom_save,
      charisma_save: neededMonster.charisma_save,
      acrobatics: neededMonster.acrobatics,
      animal_handling: neededMonster.animal_handling,
      arcana: neededMonster.arcana,
      athletics: neededMonster.athletics,
      deception: neededMonster.deception,
      history: neededMonster.history,
      insight: neededMonster.insight,
      intimidation: neededMonster.intimidation,
      investigation: neededMonster.investigation,
      medicine: neededMonster.medicine,
      nature: neededMonster.nature,
      perception: neededMonster.perception,
      performance: neededMonster.performance,
      persuasion: neededMonster.persuasion,
      religion: neededMonster.religion,
      sleight_of_hand: neededMonster.sleight_of_hand,
      stealth: neededMonster.stealth,
      survival: neededMonster.survival,
      armor_class: neededMonster.armor_class,
      speed: neededMonster.speed,
      hit_points: neededMonster.hit_points,
      hit_dice: neededMonster.hit_dice,
      actions: neededMonster.actions,
      action_names: [],
      action_descs: [],
      legendary_actions: neededMonster.legendary_actions,
      legendary_action_names: [],
      legendary_action_descs: [],
      special_abilities: neededMonster.special_abilities,
      special_ability_names: [],
      special_ability_descs: [],
      regional_effects: neededMonster.regional_effects,

      regional_effect_descs: [],
      lair_actions: neededMonster.lair_actions,

      lair_action_descs: [],
      spells: neededMonster.spells,
      spell_names: [],
      spell_schools: [],
      spell_components: [],
      spell_casting_times: [],
      ...
      spell_descriptions: [],
      spell_levels: [],
      spellcasting_ability: neededMonster.spellcasting_ability,
      spell_save_dc: neededMonster.spell_save_dc,
      spell_attack_bonus: neededMonster.spell_attack_bonus,
      damage_vulnerabilities: neededMonster.damage_vulnerabilities,
      damage_resistances: neededMonster.damage_resistances,
      damage_immunities: neededMonster.damage_immunities,
      condition_immunities: neededMonster.condition_immunities,
      challenge_rating: neededMonster.challenge_rating,
      size: neededMonster.size,
      type: neededMonster.type,
      subtype: neededMonster.subtype,
      senses: neededMonster.senses,
      languages: neededMonster.languages,
      information: neededMonster.information,
      first_level_spell_slots: neededMonster.first_level_spell_slots,
      second_level_spell_slots: neededMonster.second_level_spell_slots,
      third_level_spell_slots: neededMonster.third_level_spell_slots,
      fourth_level_spell_slots: neededMonster.fourth_level_spell_slots,
      fifth_level_spell_slots: neededMonster.fifth_level_spell_slots,
      sixth_level_spell_slots: neededMonster.sixth_level_spell_slots,
      seventh_level_spell_slots: neededMonster.seventh_level_spell_slots,
      eighth_level_spell_slots: neededMonster.eighth_level_spell_slots,
      ninth_level_spell_slots: neededMonster.ninth_level_spell_slots,
      description: neededMonster.description
    });
  };
  ...
  onSubmit = e => {
    ...
    this.props.editMonster(monData, this.state.monsterId, this.props.history);
  };
  ...
  render() {
    ...
    return (
      ...
      <div
        ...
        <div onClick={this.onSubmit} className="BookSubmitButton MonsterColor">
          <div className="ButtonColorHelper">
            <div className="CenteredPlusNoColor">Save Monster</div>
          </div>
        </div>
      </div>
    );
...
EditMonster.propTypes = {
  editMonster: PropTypes.func.isRequired,
