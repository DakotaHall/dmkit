...
import { createQuest, getCurrentProfile } from "../../actions/profileActions";
...
class CreateQuest extends Component {
  ...
  onSubmit = e => {
    ...
    this.props.createQuest(questData, this.props.history);
  };
...
export default connect(
  mapStateToProps,
  { createQuest, getCurrentProfile }
)(withRouter(CreateQuest));
